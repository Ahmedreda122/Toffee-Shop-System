...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //      String query = "insert into persons(name, email, password, phoneNum, address, type) values('ahmedReda', 'ahmalolyreda@gmail.com', 'ahmed123sd#@', '01123568974', 'ahmedredashahtabayoumi','admin')";
        //     **print table
        ...
        // user.signUp("abdelrhmanSayed", "abdelrhman1220@gmail.com", "abdelrhamn123###", "01017262334", "harem", "user");
        ...
        if(choice.equals("1")){
            ...
            while(true){
                ...
                if(v.checkEmail(email)){
                    ...
                    System.out.print("\t\t*** Try again.Please enter email like this form (chars + @ + (char) + . + com) ***\n");
                }
            }
            while(true){
                ...
                if(v.checkPhoneNumber(phoneNumber)){
                    ...
                    System.out.print("\t\t**** Please enter the mobile number formats for Egyptian mobile numbers ****\n");
                }
            }
            ...
            while(true){
                ...
                if(v.checkPassWord(password)){
                    ...
                    System.out.print("\t\t**** Please enter Strong password with this format(At least 7 char and At least 2 spcail char) ****\n");
                }
